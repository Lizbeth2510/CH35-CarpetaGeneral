...
//2. Método constructor ---> Tienen el mismo nombre que la clase, no retorna nada, recibe parametros (atributos) y los asigna a variables del constructor (this)
	Employee(String nombre, String apellido, int id, double salario, String puesto){ //toma a nuestros atributos como parametros
		this.nombre = nombre;
...
//3.Métodos de comportamiento ---> ¿Qué puede hace un empleado?
		void trabajar() {
