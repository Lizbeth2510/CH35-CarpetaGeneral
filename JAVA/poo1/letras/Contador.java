 ...
 * Necitamos establecer dos grupos de métodos
...
public class Contador {
	...
	public boolean esNumero(char caracter) {
		//casting para poder utilizar la tabla ASCII (del 48 al 57)
	...
	//castear / casteo --->conversión de datos 
	

	//Grupo 2
	
	//Métodos contar vocales 
