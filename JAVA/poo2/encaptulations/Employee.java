...
//1. Encapsular Atributos o propiedades  utilizand un modificador private
...
//2. Encapsular el Método constructor de tipo public ---> Tienen el mismo nombre que la clase, no retorna nada, recibe parametros (atributos) y los asigna a variables del constructor (this)
	 public Employee(String nombre, String apellido, int id, double salario, String puesto){ //toma a nuestros atributos como parametros
		this.nombre = nombre;
...
//3.Encapsular Métodos de comportamiento de tipo public  ---> ¿Qué puede hace un empleado?
...
//4. Getters y Setters---> Son métodos que nos permiten obtener o enviar información que está protegida por modificadores de acceso y de esta manera interactuar con nuestros objetos. Los getters nos permien pntener la info y los setters nos permiten enviar la info.
...
// 5. Método toString --> Es un "Override" que se refiera a la capacidad de proporcionar infomación especifica de una clase en forma de cadena de caracteres. Nos permite imprimir nuestros objetos en formato String
		
//Podemos inicializar toString  dando click derecho > Source > Generate toString > Fields > Generate

		@Override // manda a llamar a una declaración como un supertipo para evitar errores en nuestros códigos 
