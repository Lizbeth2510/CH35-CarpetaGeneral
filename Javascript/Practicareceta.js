...
metdoParseInt = console.log(typeof parseInt (harina));

//Conversion de la nutella de number a string
console.log(typeof String (nutella))
nutella = "Mucha";

//Impresion de los ingredientes

document.write( `Ingredientes: <br><br>
${huevos} huevos <br><br>
${leche} de leche <br><br>
${mantequilla} de mantequilla<br><br>
${harina} de harina<br><br>
${nutella} nutella<br><br><br>`);

//Lista del procedimiento
